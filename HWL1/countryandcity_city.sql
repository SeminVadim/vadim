...
CREATE TABLE `city` (
  ...
  `citytype_id` int unsigned NOT NULL,
  ...
  KEY `citytype_id_idx` (`citytype_id`),
  KEY `region_id_idx` (`region_id`),
  KEY `area_id_idx` (`area_id`),
  CONSTRAINT `area_id` FOREIGN KEY (`area_id`) REFERENCES `area` (`id`),
  CONSTRAINT `citytype_id` FOREIGN KEY (`citytype_id`) REFERENCES `citytype` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Dump completed on 2020-11-01 19:24:25
