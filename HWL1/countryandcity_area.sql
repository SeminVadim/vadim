...
CREATE TABLE `area` (
  ...
  `capital_area` int unsigned NOT NULL,
  `telcode` int unsigned NOT NULL,
  `autocode` int unsigned NOT NULL,
  `coutry_id` int unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `fullname_UNIQUE` (`fullname`),
  UNIQUE KEY `shortname_UNIQUE` (`shortname`),
  UNIQUE KEY `capital_area_UNIQUE` (`capital_area`),
  UNIQUE KEY `telcode_UNIQUE` (`telcode`),
  UNIQUE KEY `autocode_UNIQUE` (`autocode`),
  CONSTRAINT `capital_area` FOREIGN KEY (`capital_area`) REFERENCES `city` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2020-11-01 19:24:26
